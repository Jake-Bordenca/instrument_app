...
class Channel():
    def __init__(self, name, group, COM, description='', *args, **kwargs):
        self.name = name
        self.group = group
        self.COM = COM
...
class Monitor(Channel):
    def __init__(self, name, group, COM, readback_command, description='', *args, **kwargs):
        super().__init__(name, group, COM, description = description, *args, **kwargs)
...
class NumericMonitor(Monitor):
    def __init__(self, name, group, COM, readback_command, description='', units='', conversion_factor=(1,0), *args, **kwargs):
